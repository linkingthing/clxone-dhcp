...
func (g *GRPCService) GetListPool4BySubnet4Id(ctx context.Context,
	...
	if subnetList, err := GetDHCPService().GetWithPool4BySubnet4Id(req.GetSubnet4Id()); err != nil {
		return nil, err
	} else {
...
func (g *GRPCService) GetListReservedPool4BySubnet4Id(ctx context.Context,
	...
	if tmpList, err := GetDHCPService().GetReservedPool4BySubnet4Id(req.GetSubnet4Id()); err != nil {
		return nil, err
	} else {
...
func (g *GRPCService) GetListReservation4BySubnet4Id(ctx context.Context,
	...
	if tmpList, err := GetDHCPService().GetReservation4BySubnet4Id(req.GetSubnet4Id()); err != nil {
		return nil, err
	} else {
...
func (g *GRPCService) GetListLease4BySubnet4Id(ctx context.Context,
	...
	if tmpList, err := GetDHCPService().GetWithLease4BySubnet4Id(req.GetSubnet4Id()); err != nil {
		return nil, err
	} else {
...
func (g *GRPCService) GetListLease4ByIp(ctx context.Context,
	...
	if tmpList, err := GetDHCPService().GetWithLease4ByIp(req.GetSubnet4Id(), req.GetIp()); err != nil {
		return nil, err
	} else {
...
func (g *GRPCService) GetListPool6BySubnet6Id(ctx context.Context,
	...
	if tmpList, err := GetDHCPService().GetWithPool6BySubnet6Id(req.GetSubnet6Id()); err != nil {
		return nil, err
	} else {
...
func (g *GRPCService) GetListReservedPool6BySubnet6Id(ctx context.Context,
	...
	if tmpList, err := GetDHCPService().GetWithReservedPool6BySubnet6Id(req.GetSubnet6Id()); err != nil {
		return nil, err
	} else {
...
func (g *GRPCService) GetListReservation6BySubnet6Id(ctx context.Context,
	...
	if tmpList, err := GetDHCPService().GetWithReservation6BySubnet6Id(req.GetSubnet6Id()); err != nil {
		return nil, err
	} else {
...
func (g *GRPCService) GetListLease6BySubnet6Id(ctx context.Context,
	...
	if tmpList, err := GetDHCPService().GetWithLease6BySubnet6Id(req.GetSubnet6Id()); err != nil {
		return nil, err
	} else {
...
func (g *GRPCService) GetListLease6ByIp(ctx context.Context,
	...
	if tmpValue, err := GetDHCPService().GetWithLease6ByIp(req.GetSubnet6Id(), req.GetIp()); err != nil {
		return nil, err
	} else {
