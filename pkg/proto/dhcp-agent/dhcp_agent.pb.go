...
var file_dhcp_agent_proto_rawDesc = []byte{
	...
	0x49, 0x53, 0x5f, 0x4d, 0x4f, 0x44, 0x45, 0x4d, 0x10, 0x80, 0x01, 0x32, 0xab, 0x11, 0x0a, 0x0b,
	...
	0x22, 0x00, 0x12, 0x64, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x53, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x36,
	...
	0x65, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x49,
	0x0a, 0x0c, 0x47, 0x65, 0x74, 0x44, 0x48, 0x43, 0x50, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x12, 0x1a,
...
var file_dhcp_agent_proto_depIdxs = []int32{
	...
	65, // 47: proto.DHCPManager.GetSubnet6LeasesCountByAddressCode:input_type -> proto.GetSubnet6LeasesCountRequest
	76, // 48: proto.DHCPManager.GetSubnet6Lease:input_type -> proto.GetSubnet6LeaseRequest
	73, // 49: proto.DHCPManager.GetSubnet6LeasesWithIps:input_type -> proto.GetSubnet6LeasesWithIpsRequest
	78, // 50: proto.DHCPManager.GetPool6Leases:input_type -> proto.GetPool6LeasesRequest
	66, // 51: proto.DHCPManager.GetPool6LeasesCount:input_type -> proto.GetPool6LeasesCountRequest
	67, // 52: proto.DHCPManager.GetReservation6LeasesCount:input_type -> proto.GetReservation6LeasesCountRequest
	68, // 53: proto.DHCPManager.GetReservation6Leases:input_type -> proto.GetReservation6LeasesRequest
	93, // 54: proto.DHCPManager.DeleteLease6:input_type -> proto.DeleteLease6Request
	2,  // 55: proto.DHCPManager.GetDHCPNodes:input_type -> proto.GetDHCPNodesRequest
	59, // 56: proto.DHCPManager.GetSubnets4LeasesCount:output_type -> proto.GetSubnetsLeasesCountResponse
	59, // 57: proto.DHCPManager.GetSubnets4LeasesCountWithIds:output_type -> proto.GetSubnetsLeasesCountResponse
	80, // 58: proto.DHCPManager.GetSubnet4Leases:output_type -> proto.GetLeases4Response
	64, // 59: proto.DHCPManager.GetSubnet4LeasesCount:output_type -> proto.GetLeasesCountResponse
	81, // 60: proto.DHCPManager.GetSubnet4Lease:output_type -> proto.GetLease4Response
	72, // 61: proto.DHCPManager.GetSubnet4LeasesWithIps:output_type -> proto.GetLeases4WithIpsResponse
	80, // 62: proto.DHCPManager.GetPool4Leases:output_type -> proto.GetLeases4Response
	64, // 63: proto.DHCPManager.GetPool4LeasesCount:output_type -> proto.GetLeasesCountResponse
	64, // 64: proto.DHCPManager.GetReservation4LeaseCount:output_type -> proto.GetLeasesCountResponse
	81, // 65: proto.DHCPManager.GetReservation4Lease:output_type -> proto.GetLease4Response
	94, // 66: proto.DHCPManager.DeleteLease4:output_type -> proto.DeleteLeaseResponse
	59, // 67: proto.DHCPManager.GetSubnets6LeasesCount:output_type -> proto.GetSubnetsLeasesCountResponse
	59, // 68: proto.DHCPManager.GetSubnets6LeasesCountWithIds:output_type -> proto.GetSubnetsLeasesCountResponse
	83, // 69: proto.DHCPManager.GetSubnet6Leases:output_type -> proto.GetLeases6Response
	64, // 70: proto.DHCPManager.GetSubnet6LeasesCount:output_type -> proto.GetLeasesCountResponse
	64, // 71: proto.DHCPManager.GetSubnet6LeasesCountByAddressCode:output_type -> proto.GetLeasesCountResponse
	84, // 72: proto.DHCPManager.GetSubnet6Lease:output_type -> proto.GetLease6Response
	74, // 73: proto.DHCPManager.GetSubnet6LeasesWithIps:output_type -> proto.GetLeases6WithIpsResponse
	83, // 74: proto.DHCPManager.GetPool6Leases:output_type -> proto.GetLeases6Response
	64, // 75: proto.DHCPManager.GetPool6LeasesCount:output_type -> proto.GetLeasesCountResponse
	64, // 76: proto.DHCPManager.GetReservation6LeasesCount:output_type -> proto.GetLeasesCountResponse
	83, // 77: proto.DHCPManager.GetReservation6Leases:output_type -> proto.GetLeases6Response
	94, // 78: proto.DHCPManager.DeleteLease6:output_type -> proto.DeleteLeaseResponse
	3,  // 79: proto.DHCPManager.GetDHCPNodes:output_type -> proto.GetDHCPNodesResponse
