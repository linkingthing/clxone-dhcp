...
func (r *Reservation6Handler) Create(ctx *restresource.Context) (restresource.Resource, *resterror.APIError) {
	...
	if err := reservation.Validate(); err != nil {
		return nil, resterror.NewAPIError(resterror.InvalidFormat,
			fmt.Sprintf("create reservation6 params invalid: %s", err.Error()))
	}
	...
	if err := restdb.WithTx(db.GetDB(), func(tx restdb.Transaction) error {
		...
		return nil, resterror.NewAPIError(resterror.ServerError,
			fmt.Sprintf("create reservation6 %s failed: %s",
...
func (r *Reservation6Handler) List(ctx *restresource.Context) (interface{}, *resterror.APIError) {
	...
	if err := db.GetResources(map[string]interface{}{
		...
		return nil, resterror.NewAPIError(resterror.ServerError,
			fmt.Sprintf("list reservation6s with subnet6 %s from db failed: %s",
				subnetID, err.Error()))
	}
...
func (r *Reservation6Handler) Get(ctx *restresource.Context) (restresource.Resource, *resterror.APIError) {
	...
	if err != nil {
		return nil, resterror.NewAPIError(resterror.ServerError,
			fmt.Sprintf("get reservation6 %s with subnet6 %s from db failed: %s",
...
func (r *Reservation6Handler) Delete(ctx *restresource.Context) *resterror.APIError {
	...
	if err := restdb.WithTx(db.GetDB(), func(tx restdb.Transaction) error {
		...
		return resterror.NewAPIError(resterror.ServerError,
			fmt.Sprintf("delete reservation6 %s with subnet6 %s failed: %s",
...
func (r *Reservation6Handler) Update(ctx *restresource.Context) (restresource.Resource, *resterror.APIError) {
	...
	if err := restdb.WithTx(db.GetDB(), func(tx restdb.Transaction) error {
		...
		return nil, resterror.NewAPIError(resterror.ServerError,
			fmt.Sprintf("update reservation6 %s with subnet6 %s failed: %s",
